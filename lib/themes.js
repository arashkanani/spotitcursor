...
function resolveThemeBackgroundForStorage(themeBackground) {
  if (isValidBackground(themeBackground) && themeBackground !== "custom") {
...
module.exports = {
  ...
  hasStoredCustomBackgrounds,
  resolveThemeBackgroundForStorage,
  normalizeTheme
};
