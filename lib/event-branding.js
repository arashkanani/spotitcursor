...
function defaultConfig() {
  return {
    ...
    wallScreenLayout: DEFAULT_WALL_SCREEN_LAYOUT
  };
}
...
function readEventConfig() {
  try {
    ...
    return {
      ...
      wallScreenLayout: normalizeWallScreenLayout(raw.wallScreenLayout)
    };
  } catch (_error) {
...
function writeEventConfig(config) {
  ...
  const payload = {
    ...
    wallScreenLayout: normalizeWallScreenLayout(config.wallScreenLayout),
...
module.exports = {
  ...
  BG_SCALE_MAX,
  WALL_SCREEN_LAYOUTS,
  DEFAULT_WALL_SCREEN_LAYOUT,
  normalizeWallScreenLayout
};
